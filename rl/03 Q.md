...
This is 03 of the act wing. A camera. Short.
...
After 400 weeks (house seed 7, from 01):
...
Same world and seed as [[01 the loop]]. Only print Q. House seed 7.
...
**Also called:** Q = action value · target = TD target · rate 0.3 = α · 0.9 = γ · try 0.2 = ε.

![ql-04-when](../assets/ql-04-when.svg)

### Use / skip

**Reach for it when** you already have the **loop**, you want a **table** not a brand, and greedy on the row is enough policy.

**Skip it when** there is no next ([[02 bandits]] — that Q is a mean); a frozen pile of people (supervised); a deep Q-net as 01.

**Pays you:** four readable cells. A policy without inventing one. The same leftover-as-target as 01, named.

**Costs you:** a small world (two states). Random tries. Not a grade. Not a sampler. Not a brand.

---

*Act 03. The table, named. Remaining rooms, short. Not a brand as 04.*
